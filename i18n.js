...
(function () {
    ...
    const dict = {
        ru: {
            ...
            'race.reset': '🔄 Сбросить',
            'race.round': 'Раунд',
            'race.roundLive': 'Текущий раунд',
            'race.roundCurrentShort': 'текущий',
            'race.roundSelectorTitle': 'Выбрать раунд',
            'race.session': 'Сессия:',
            ...
            'confirm.resetRace': 'Сбросить гонку? Текущие результаты сначала будут сохранены в историю, после чего гонка вернётся в режим ожидания (игроки останутся, время и сплиты обнулятся).',
            ...
            'alert.resetError': 'Ошибка сброса: ',
            'alert.saveError': 'Ошибка сохранения: ',
            'toast.raceDeleted': 'Гонка удалена',
            'toast.raceReset': 'Гонка сброшена',
            'toast.raceResetSaved': 'Результаты сохранены в историю, гонка сброшена',
        ...
        en: {
            ...
            'race.reset': '🔄 Reset',
            'race.round': 'Round',
            'race.roundLive': 'Current round',
            'race.roundCurrentShort': 'current',
            'race.roundSelectorTitle': 'Select round',
            ...
            'confirm.resetRace': 'Reset the race? Current results will be saved to history first, then the race returns to waiting (players stay, times and splits are cleared).',
            ...
            'alert.resetError': 'Reset error: ',
            'alert.saveError': 'Save error: ',
            'toast.raceDeleted': 'Race deleted',
            'toast.raceReset': 'Race has been reset',
            'toast.raceResetSaved': 'Results saved to history, race reset',
