...
(function () {
    ...
    const dict = {
        ru: {
            'obs.title': 'Настройки OBS Overlay',
            'obs.player': 'Игрок',
            'obs.showName': 'Показывать ник',
            'obs.showTimer': 'Показывать таймер',
            'obs.showSplit': 'Показывать текущий сплит',
            'obs.showMillis': 'Показывать миллисекунды',
            'obs.timerColor': 'Цвет таймера',
            'obs.nameColor': 'Цвет ника',
            'obs.splitColor': 'Цвет сплита',
            'obs.bgColor': 'Фон (HEX/transparent)',
            'obs.position': 'Расположение',
            'obs.pos.tl': 'Сверху Слева',
            'obs.pos.tc': 'Сверху по Центру',
            'obs.pos.tr': 'Сверху Справа',
            'obs.pos.bl': 'Снизу Слева',
            'obs.pos.bc': 'Снизу по Центру',
            'obs.pos.br': 'Снизу Справа',
            'obs.url': 'URL для Browser Source',
            'obs.copy': 'Копировать URL',
            'race.obsBtn': '📺 OBS Overlay',
        ...
        en: {
            'obs.title': 'OBS Overlay Settings',
            'obs.player': 'Player',
            'obs.showName': 'Show Name',
            'obs.showTimer': 'Show Timer',
            'obs.showSplit': 'Show Current Split',
            'obs.showMillis': 'Show Milliseconds',
            'obs.timerColor': 'Timer Color',
            'obs.nameColor': 'Name Color',
            'obs.splitColor': 'Split Color',
            'obs.bgColor': 'Background Color (HEX/transparent)',
            'obs.position': 'Layout Position',
            'obs.pos.tl': 'Top Left',
            'obs.pos.tc': 'Top Center',
            'obs.pos.tr': 'Top Right',
            'obs.pos.bl': 'Bottom Left',
            'obs.pos.bc': 'Bottom Center',
            'obs.pos.br': 'Bottom Right',
            'obs.url': 'Browser Source URL',
            'obs.copy': 'Copy URL',
            'race.obsBtn': '📺 OBS Overlay',
